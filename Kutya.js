...
export default class FetchExample extends React.Component {
  ...
  fetch("http://192.168.137.1:3000/szavazatfelvitel", {
      method: "POST",
  ...
  componentDidMount(){
    return fetch('http://192.168.137.1:3000/kutya')
    ...
    return(
      <View style={{flex: 1, paddingTop:20}}>
        <FlatList
          ...
          <Image  source={{uri: 'http://192.168.137.1:3000/'+item.kutya_kep}} style={{width:300,height:300,marginLeft:"auto",marginRight:"auto"}} /> 
